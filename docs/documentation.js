...
var DocumentationPage = (function() {
  ...
  function reviewingEN() {
    return '<h1>Reviewing & Proposing on GitHub</h1>'
      ...
      + '<td style="padding:3px 0; border:none; font-family:inherit; color:var(--text)">unit_conversions.json + recommended_units.json</td></tr>'
  ...
  function sourcesEN() {
    return '<h1>Sources</h1>'
      + '<p>This page lists every external source the INDICATE Data Dictionary draws on, '
      + 'and pinpoints the exact file and column where each piece of information lives. '
      + 'Use it to audit a value, refresh the dictionary against a new release, or extend it with a new concept set.</p>'

      // ===== CONCEPT SET DEFINITIONS =====
      + '<h2>Concept set descriptions</h2>'
      + '<p>Concept set descriptions (the <em>Definition &amp; Clinical Context</em>, <em>Included Concepts</em>, '
      + '<em>Excluded Concepts</em>, and <em>Mapping Notes</em> sections shown in the Comments tab) are written from '
      + 'four primary terminology sources, in priority order. When the concept set contains <strong>LOINC</strong> '
      + 'concepts, LOINC is used first — its <em>Part description</em> texts give concise, mapping-ready definitions. '
      + '<strong>SNOMED CT</strong> comes next, especially for clinical findings, procedures, and observable entities. '
      + '<strong>UMLS</strong> is used as a fallback when LOINC and SNOMED are thin, and <strong>web sources</strong> '
      + 'as a last resort.</p>'

      + '<h3>1. LOINC</h3>'
      + '<p>Edited and distributed by the Regenstrief Institute (Indianapolis, USA). Preferred source whenever '
      + 'the concept set includes LOINC concepts — its <em>Part description</em> texts give concise, mapping-ready '
      + 'definitions.</p>'
      + '<ul>'
      + '<li><strong>Download</strong>: <a href="https://loinc.org/downloads/" target="_blank">https://loinc.org/downloads/</a> (free, registration required).</li>'
      + '<li><strong>File used</strong>: <code>LoincTable/Loinc.csv</code> from the LOINC distribution.</li>'
      + '<li><strong>Key columns</strong>:'
      + '<ul>'
      + '<li><code>LOINC_NUM</code> — the LOINC code.</li>'
      + '<li><code>COMPONENT</code>, <code>PROPERTY</code>, <code>TIME_ASPCT</code>, <code>SYSTEM</code>, <code>SCALE_TYP</code>, <code>METHOD_TYP</code> — the six axes of the LOINC decomposition.</li>'
      + '<li><code>LONG_COMMON_NAME</code> — full descriptive name.</li>'
      + '<li><code>CONSUMER_NAME</code> — patient-friendly name.</li>'
      + '<li><code>RELATEDNAMES2</code> — related keywords.</li>'
      + '<li><code>EXAMPLE_UCUM_UNITS</code> — the UCUM unit most commonly observed.</li>'
      + '<li><code>CLASS</code> — LOINC class.</li>'
      + '<li><code>ORDER_OBS</code> — order vs observation.</li>'
      + '</ul></li>'
      + '<li><strong>Accessory files</strong>: <code>AccessoryFiles/PartFile/Part.csv</code> for component (<em>Part</em>) descriptions, '
      + '<code>AccessoryFiles/ConsumerName/ConsumerName.csv</code> for patient-friendly names.</li>'
      + '<li><strong>Web fallback</strong>: per-code pages at <code>https://loinc.org/{loinc_code}/</code> '
      + '— the <em>Part description</em> section is the preferred source for defining the measured substance.</li>'
      + '</ul>'

      + '<h3>2. SNOMED CT</h3>'
      + '<p>Edited by SNOMED International (UK). Distributed in the US by the National Library of Medicine, '
      + 'and in other countries by national release centres. Used in priority for concept sets without LOINC concepts '
      + '(clinical findings, procedures, observable entities).</p>'
      + '<ul>'
      + '<li><strong>Download</strong>: <a href="https://www.nlm.nih.gov/healthit/snomedct/international.html" target="_blank">'
      + 'https://www.nlm.nih.gov/healthit/snomedct/international.html</a> (free, UMLS licence required).</li>'
      + '<li><strong>Format</strong>: RF2 release ZIP (e.g. <code>SnomedCT_InternationalRF2_PRODUCTION_20251101T120000Z.zip</code>).</li>'
      + '<li><strong>Files used</strong> (inside <code>Snapshot/Terminology/</code>):'
      + '<ul>'
      + '<li><code>sct2_Description_Snapshot-en_*.txt</code> — Fully Specified Names (FSN) and synonyms. Columns:'
      + '<ul>'
      + '<li><code>id</code> — description identifier.</li>'
      + '<li><code>conceptId</code> — SNOMED concept identifier.</li>'
      + '<li><code>languageCode</code> — language (e.g. <code>en</code>).</li>'
      + '<li><code>typeId</code> — description type (<code>900000000000003001</code> = FSN, <code>900000000000013009</code> = Synonym).</li>'
      + '<li><code>term</code> — the term itself.</li>'
      + '</ul></li>'
      + '<li><code>sct2_TextDefinition_Snapshot-en_*.txt</code> — full text definitions '
      + '(only present for ~3.6% of concepts). Columns:'
      + '<ul>'
      + '<li><code>conceptId</code> — SNOMED concept identifier.</li>'
      + '<li><code>term</code> — the definition text.</li>'
      + '</ul></li>'
      + '</ul></li>'
      + '</ul>'

      + '<h3>3. UMLS</h3>'
      + '<p>UMLS Metathesaurus — edited and distributed by the US National Library of Medicine. Used as a '
      + 'fallback for clinical definitions when LOINC <em>Part description</em> and SNOMED are thin or absent.</p>'
      + '<ul>'
      + '<li><strong>Download</strong>: <a href="https://www.nlm.nih.gov/research/umls/licensedcontent/umlsknowledgesources.html" target="_blank">'
      + 'https://www.nlm.nih.gov/research/umls/licensedcontent/umlsknowledgesources.html</a> '
      + '(free, UMLS licence required). Use the <em>Metathesaurus Full Subset</em>.</li>'
      + '<li><strong>Files used</strong> (RRF format, pipe-delimited):'
      + '<ul>'
      + '<li><code>MRCONSO.RRF</code> — concept names and synonyms. Filter on <code>LAT=ENG</code> and the desired source vocabulary '
      + '(<code>SAB</code>, e.g. <code>MSH</code>, <code>NCI</code>, <code>SNOMEDCT_US</code>) to find the parent CUI for the measured substance.</li>'
      + '<li><code>MRDEF.RRF</code> — definitions. Lookup by CUI; preferred sources in this order: '
      + '<code>MSH</code> (MeSH), <code>NCI</code> (NCI Thesaurus), <code>CSP</code> (CRISP), '
      + '<code>ICF</code> (International Classification of Functioning), <code>HPO</code> (Human Phenotype Ontology), <code>MEDLINEPLUS</code>.</li>'
      + '<li><code>MRSTY.RRF</code> — semantic type (e.g. <em>T201 — Clinical Attribute</em>).</li>'
      + '<li><code>MRREL.RRF</code> — relationships (parent/child, related concepts).</li>'
      + '</ul></li>'
      + '</ul>'

      + '<h3>4. Web sources</h3>'
      + '<p>Last-resort sources cited in the <em>References</em> section.</p>'
      + '<p>For niche concepts where LOINC, SNOMED, and UMLS provide insufficient context, peer-reviewed clinical '
      + 'guidelines, society position statements, or established medical references (StatPearls, UpToDate, society websites) '
      + 'may be cited. Every web source is recorded in the <em>References</em> section of the concept set description '
      + '(numbered, Vancouver-style, with a clickable URL).</p>'

      // ===== RECOMMENDED UNITS =====
      + '<h2>Recommended units</h2>'
      + '<p>Stored in <code>units/recommended_units.json</code>.</p>'
      + '<p>The recommended unit for each measurement concept comes from two sources, in priority order. '
      + 'For laboratory measurements, <strong>NPU</strong> is the primary source — it is the IFCC/IUPAC reference '
      + 'and explicitly publishes the SI / IFCC-recommended unit for each measurand. When NPU does not cover the '
      + 'measurement, <strong>LOINC <code>EXAMPLE_UCUM_UNITS</code></strong> is used as a fallback (the unit most '
      + 'commonly observed in practice for that LOINC code). For non-laboratory measurements (vital signs, '
      + 'anthropometrics, scales, drug doses), no formal source is adopted yet.</p>'

      + '<h3>1. NPU</h3>'
      + '<p>Primary source for laboratory measurements. <em>Nomenclature for Properties and Units</em> '
      + '(IFCC / IUPAC). NPU is broader than JCTLM (it covers concentrations, '
      + 'activities, ratios, qualitative panels) and explicitly publishes both the SI variant and the conventional '
      + 'variant when both are in use (e.g. <code>µkat/L</code> and <code>U/L</code> for enzyme activities).</p>'
      + '<ul>'
      + '<li><strong>Download</strong>: <a href="https://npu-terminology.org/npu-database/" target="_blank">'
      + 'https://npu-terminology.org/npu-database/</a> (free).</li>'
      + '<li><strong>File used</strong>: the latest <code>npu-codes-latest.csv</code>.</li>'
      + '<li><strong>Key columns</strong>:'
      + '<ul>'
      + '<li><code>npu_code</code> — the NPU code.</li>'
      + '<li><code>system</code> — specimen (e.g. <code>Plasma</code>, <code>Serum</code>, <code>Capillary blood</code>, <code>Blood</code>, <code>Patient(blood)</code>).</li>'
      + '<li><code>component</code> — the measured substance (e.g. <em>Bilirubins</em>, <em>Glucose</em>).</li>'
      + '<li><code>kind_of_property</code> — type of property (e.g. <em>substance concentration</em>, <em>catalytic activity concentration</em>).</li>'
      + '<li><code>unit</code> — full unit name (e.g. <em>micromole per litre</em>).</li>'
      + '<li><code>unit_short</code> — UCUM-like short form (e.g. <code>µmol/L</code>, <code>µkat/L</code>, <code>U/L</code>).</li>'
      + '<li><code>active</code> — <code>1</code> for currently active rows.</li>'
      + '</ul></li>'
      + '<li><strong>Filter</strong>: <code>active = 1</code> and <code>component</code> matching the measured substance. '
      + 'For enzymes, two rows usually exist (SI variant <code>µkat/L</code> and conventional variant <code>U/L</code>) '
      + '— both are accepted; pick the variant labs actually report.</li>'
      + '</ul>'

      + '<h3>2. LOINC (fallback)</h3>'
      + '<p>Used when the measurement is not covered by NPU. The recommended unit is read from the '
      + '<code>EXAMPLE_UCUM_UNITS</code> column of <code>LoincTable/Loinc.csv</code>. Note that a unit picked from '
      + 'LOINC alone should not be advertised as the "SI unit" or "IFCC-recommended" — those claims require NPU '
      + 'as a citable source.</p>'
      + '<ul>'
      + '<li><strong>File</strong>: <code>LoincTable/Loinc.csv</code> (LOINC distribution — see Concept set definitions above for download).</li>'
      + '<li><strong>Column</strong>: <code>EXAMPLE_UCUM_UNITS</code> — the UCUM unit most commonly observed in practice '
      + 'for that LOINC code, as published by Regenstrief.</li>'
      + '<li><strong>Multiple values</strong>: the column may list several units separated by <code>;</code> '
      + '(e.g. <code>mg/dL;mg/L</code> for some albumin assays). Pick the one matching the LOINC <code>PROPERTY</code> '
      + '(<code>µmol/L</code> for <em>SCnc</em> / <em>Moles/volume</em>, <code>mg/dL</code> for <em>MCnc</em> / <em>Mass/volume</em>); '
      + 'when the property does not disambiguate, pick the one most commonly used in practice and document the choice.</li>'
      + '</ul>'

      + '<h3>3. Non-laboratory measurements</h3>'
      + '<p>For vital signs, anthropometrics, scales, drug doses and other non-laboratory measurements, the '
      + 'methodology for choosing a recommended unit is <strong>not yet defined</strong>: LOINC '
      + '<code>EXAMPLE_UCUM_UNITS</code> is sparse in these domains, NPU does not cover them, and no single '
      + 'cross-domain reference has been adopted yet. For the moment, recommended units in these domains are '
      + 'populated on a case-by-case basis (clinical guidelines, common practice).</p>'

      // ===== UNIT CONVERSIONS =====
      + '<h2>Conversion factors</h2>'
      + '<p>Stored in <code>units/unit_conversions.json</code>.</p>'
      + '<p>Conversion factors come from the official French national reference for laboratory result exchange:</p>'
      + '<ul>'
      + '<li><strong>Source</strong>: <em>Jeu de valeurs Circuit de la biologie</em>, published by the '
      + '<strong>Agence du Numérique en Santé (ANS)</strong> as part of the French digital health interoperability framework (CI-SIS).</li>'
      + '<li><strong>Landing page</strong>: <a href="https://smt.esante.gouv.fr/terminologie-jeu-de-valeurs-circuit-de-la-biologie/" target="_blank">'
      + 'https://smt.esante.gouv.fr/terminologie-jeu-de-valeurs-circuit-de-la-biologie/</a></li>'
      + '<li><strong>Download</strong>: the ZIP archive linked from the page above '
      + '(e.g. <code>terminologie-jeu-de-valeurs-circuit-de-la-biologie-1.1.23.zip</code>). The relevant file is '
      + '<code>dat/ANS_JDV_CircuitBio.xlsx</code>.</li>'
      + '<li><strong>Sheet</strong>: <code>1.JDV_CircuitBio</code> — one row per LOINC code in the French national value set '
      + '(~7 100 rows in v1.1.23).</li>'
      + '<li><strong>Header layout</strong>: row 1 is a thematic banner (e.g. <em>Renseignements prélèvements</em>, '
      + '<em>ANALYSES PORTEUSES DE RESULTAT</em>), row 2 is the actual column header, data starts at row 3.</li>'
      + '<li><strong>Key columns</strong>:'
      + '<ul>'
      + '<li>Column 19 — <code>LOINC</code> — the LOINC code of the measurement (e.g. <code>14749-6</code>).</li>'
      + '<li>Column 20 — <em>Libellés français de référence</em>.</li>'
      + '<li>Column 24 — <em>Unité recommandée</em> — the recommended unit (e.g. <code>mmol/L</code>).</li>'
      + '<li>Column 25 — <em>Unité UCUM</em> — the UCUM-formatted unit.</li>'
      + '<li>Column 27 — <em>Correspondance</em> — the LOINC code of the partner test '
      + '(same measurement, alternative unit; e.g. <code>14749-6</code> Glucose <em>mmol/L</em> ↔ <code>2345-7</code> Glucose <em>g/L</em>).</li>'
      + '<li>Column 28 — <em>Facteur de conversion des unités</em> — the multiplicative factor to convert from this row’s unit '
      + 'to the partner row’s unit (e.g. <code>0.18</code> from <code>mmol/L</code> Glucose to <code>g/L</code>, '
      + '<code>5.551</code> in the reverse direction).</li>'
      + '</ul></li>'
      + '<li><strong>Mapping into INDICATE</strong>: each ANS row produces (up to) one entry in '
      + '<code>units/unit_conversions.json</code> with <code>conceptId</code> = OMOP concept ID for column 19’s LOINC, '
      + '<code>sourceUnitCode</code> = column 24, <code>targetUnitCode</code> = the partner row’s column 24, '
      + '<code>conversionFactor</code> = column 28. Both directions are stored as separate rows '
      + '(one row per direction, as documented in the schema).</li>'
      + '<li><strong>Companion documentation</strong>: <code>doc/Guide_Implementation_JDV_Circuit_de_biologie.pdf</code> and '
      ...
      + '<p>Every concept in the dictionary references an OMOP <code>concept_id</code>. Concept metadata '
      + '(<code>concept_name</code>, <code>concept_code</code>, <code>vocabulary_id</code>, <code>domain_id</code>, '
      + '<code>concept_class_id</code>, <code>standard_concept</code>, <code>valid_start_date</code>, <code>valid_end_date</code>) '
      + 'is hydrated from the OHDSI Athena vocabulary tables.</p>'
      + '<ul>'
      + '<li><strong>Download</strong>: <a href="https://athena.ohdsi.org/" target="_blank">https://athena.ohdsi.org/</a> '
      + '(free, OHDSI account required). Select the vocabularies needed (LOINC, SNOMED, RxNorm, ATC, UCUM, etc.) and download as CSV.</li>'
      + '<li><strong>Tables used</strong>: <code>CONCEPT</code>, <code>CONCEPT_ANCESTOR</code>, <code>CONCEPT_RELATIONSHIP</code>, '
      + '<code>CONCEPT_SYNONYM</code>, <code>RELATIONSHIP</code>, <code>VOCABULARY</code>, <code>DOMAIN</code>, '
      + '<code>CONCEPT_CLASS</code>, optionally <code>DRUG_STRENGTH</code>.</li>'
      + '<li><strong>Per-concept lookup</strong>: <code>https://athena.ohdsi.org/search-terms/terms/{conceptId}</code> '
      + '(linked from every concept in the SPA).</li>'
      + '<li><strong>Local query</strong>: the same CSV files can be loaded into the in-browser DuckDB-WASM database '
      + '(see ' + docLink('dictionary-settings', 'Dictionary Settings') + ' → General Settings → Vocabulary import) '
      + 'and queried from ' + docLink('dev-tools', 'Dev Tools') + '.</li>'
      + '</ul>'

      // ===== UCUM =====
      + '<h2>UCUM</h2>'
      + '<p>All unit codes in the dictionary follow UCUM (<em>Unified Code for Units of Measure</em>) syntax. '
      + 'UCUM is also distributed as an OMOP vocabulary '
      + '(every unit has an OMOP <code>concept_id</code>, e.g. <code>8753 — mmol/L</code>, <code>8636 — g/L</code>, '
      + '<code>8554 — %</code>).</p>'
      + '<ul>'
  ...
  function sourcesFR() {
    return '<h1>Sources</h1>'
      + '<p>Cette page recense l\u2019ensemble des sources externes utilis\u00e9es par le dictionnaire de donn\u00e9es INDICATE, '
      + 'et indique pr\u00e9cis\u00e9ment le fichier et la colonne o\u00f9 chaque information est extraite. '
      + 'Elle sert \u00e0 auditer une valeur, mettre \u00e0 jour le dictionnaire vis-\u00e0-vis d\u2019une nouvelle release, '
      + 'ou ajouter un nouveau jeu de concepts.</p>'

      // ===== CONCEPT SET DEFINITIONS =====
      + '<h2>Descriptions des jeux de concepts</h2>'
      + '<p>Les descriptions des jeux de concepts (sections <em>D\u00e9finition &amp; contexte clinique</em>, '
      + '<em>Concepts inclus</em>, <em>Concepts exclus</em>, <em>Notes de mapping</em> affich\u00e9es dans l\u2019onglet '
      + 'Commentaires) sont r\u00e9dig\u00e9es \u00e0 partir de quatre sources terminologiques principales, par ordre de priorit\u00e9. '
      + 'Quand le jeu de concepts contient des concepts <strong>LOINC</strong>, LOINC est utilis\u00e9 en priorit\u00e9 \u2014 '
      + 'ses <em>Part descriptions</em> fournissent des d\u00e9finitions concises et directement exploitables pour le mapping. '
      + '<strong>SNOMED CT</strong> vient ensuite, en particulier pour les constatations cliniques, les actes et les '
      + 'entit\u00e9s observables. <strong>UMLS</strong> sert de source de repli quand LOINC et SNOMED sont pauvres, et '
      + 'les <strong>sources web</strong> sont mobilis\u00e9es en dernier recours.</p>'

      + '<h3>1. LOINC</h3>'
      + '<p>\u00c9dit\u00e9 et distribu\u00e9 par le Regenstrief Institute (Indianapolis, \u00c9tats-Unis). Source privil\u00e9gi\u00e9e d\u00e8s lors '
      + 'que le jeu de concepts contient des concepts LOINC \u2014 ses <em>Part descriptions</em> fournissent des d\u00e9finitions '
      + 'concises et directement exploitables pour le mapping.</p>'
      + '<ul>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: <a href="https://loinc.org/downloads/" target="_blank">https://loinc.org/downloads/</a> (gratuit, inscription requise).</li>'
      + '<li><strong>Fichier utilis\u00e9</strong>\u00a0: <code>LoincTable/Loinc.csv</code> dans la distribution LOINC.</li>'
      + '<li><strong>Colonnes cl\u00e9s</strong>\u00a0:'
      + '<ul>'
      + '<li><code>LOINC_NUM</code> \u2014 le code LOINC.</li>'
      + '<li><code>COMPONENT</code>, <code>PROPERTY</code>, <code>TIME_ASPCT</code>, <code>SYSTEM</code>, <code>SCALE_TYP</code>, <code>METHOD_TYP</code> \u2014 les six axes de la d\u00e9composition LOINC.</li>'
      + '<li><code>LONG_COMMON_NAME</code> \u2014 nom complet d\u00e9velopp\u00e9.</li>'
      + '<li><code>CONSUMER_NAME</code> \u2014 nom grand public.</li>'
      + '<li><code>RELATEDNAMES2</code> \u2014 mots-cl\u00e9s associ\u00e9s.</li>'
      + '<li><code>EXAMPLE_UCUM_UNITS</code> \u2014 unit\u00e9 UCUM la plus fr\u00e9quemment observ\u00e9e.</li>'
      + '<li><code>CLASS</code> \u2014 classe LOINC.</li>'
      + '<li><code>ORDER_OBS</code> \u2014 prescription / observation.</li>'
      + '</ul></li>'
      + '<li><strong>Fichiers compl\u00e9mentaires</strong>\u00a0: <code>AccessoryFiles/PartFile/Part.csv</code> pour les descriptions '
      + 'de composants (<em>Part</em>), <code>AccessoryFiles/ConsumerName/ConsumerName.csv</code> pour les noms grand public.</li>'
      + '<li><strong>Compl\u00e9ment web</strong>\u00a0: pages par code \u00e0 l\u2019URL <code>https://loinc.org/{loinc_code}/</code> '
      + '\u2014 la section <em>Part description</em> est la source pr\u00e9f\u00e9r\u00e9e pour d\u00e9finir la grandeur mesur\u00e9e.</li>'
      + '</ul>'

      + '<h3>2. SNOMED CT</h3>'
      + '<p>\u00c9dit\u00e9 par SNOMED International (Royaume-Uni). Distribu\u00e9 aux \u00c9tats-Unis par la National Library of Medicine, '
      + 'et dans les autres pays par les centres nationaux de release. Utilis\u00e9 en priorit\u00e9 pour les jeux de concepts '
      + 'sans concepts LOINC (constatations cliniques, actes, entit\u00e9s observables).</p>'
      + '<ul>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: <a href="https://www.nlm.nih.gov/healthit/snomedct/international.html" target="_blank">'
      + 'https://www.nlm.nih.gov/healthit/snomedct/international.html</a> (gratuit, licence UMLS requise).</li>'
      + '<li><strong>Format</strong>\u00a0: archive RF2 (par ex. <code>SnomedCT_InternationalRF2_PRODUCTION_20251101T120000Z.zip</code>).</li>'
      + '<li><strong>Fichiers utilis\u00e9s</strong> (dans <code>Snapshot/Terminology/</code>)\u00a0:'
      + '<ul>'
      + '<li><code>sct2_Description_Snapshot-en_*.txt</code> \u2014 Fully Specified Names (FSN) et synonymes. Colonnes\u00a0:'
      + '<ul>'
      + '<li><code>id</code> \u2014 identifiant de la description.</li>'
      + '<li><code>conceptId</code> \u2014 identifiant du concept SNOMED.</li>'
      + '<li><code>languageCode</code> \u2014 langue (par ex. <code>en</code>).</li>'
      + '<li><code>typeId</code> \u2014 type de description (<code>900000000000003001</code> = FSN, <code>900000000000013009</code> = Synonyme).</li>'
      + '<li><code>term</code> \u2014 le libell\u00e9.</li>'
      + '</ul></li>'
      + '<li><code>sct2_TextDefinition_Snapshot-en_*.txt</code> \u2014 d\u00e9finitions textuelles compl\u00e8tes '
      + '(disponibles seulement pour ~3,6\u00a0% des concepts). Colonnes\u00a0:'
      + '<ul>'
      + '<li><code>conceptId</code> \u2014 identifiant du concept SNOMED.</li>'
      + '<li><code>term</code> \u2014 le texte de la d\u00e9finition.</li>'
      + '</ul></li>'
      + '</ul></li>'
      + '</ul>'

      + '<h3>3. UMLS</h3>'
      + '<p>UMLS Metathesaurus \u2014 \u00e9dit\u00e9 et distribu\u00e9 par la US National Library of Medicine. Utilis\u00e9 comme '
      + 'source de repli pour les d\u00e9finitions cliniques quand la <em>Part description</em> LOINC et SNOMED sont '
      + 'pauvres ou absentes.</p>'
      + '<ul>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: <a href="https://www.nlm.nih.gov/research/umls/licensedcontent/umlsknowledgesources.html" target="_blank">'
      + 'https://www.nlm.nih.gov/research/umls/licensedcontent/umlsknowledgesources.html</a> '
      + '(gratuit, licence UMLS requise). Utiliser le <em>Metathesaurus Full Subset</em>.</li>'
      + '<li><strong>Fichiers utilis\u00e9s</strong> (format RRF, s\u00e9parateur pipe)\u00a0:'
      + '<ul>'
      + '<li><code>MRCONSO.RRF</code> \u2014 noms et synonymes des concepts. Filtrer sur <code>LAT=ENG</code> et le vocabulaire '
      + 'source souhait\u00e9 (<code>SAB</code>, par ex. <code>MSH</code>, <code>NCI</code>, <code>SNOMEDCT_US</code>) pour '
      + 'remonter au CUI parent de la grandeur mesur\u00e9e.</li>'
      + '<li><code>MRDEF.RRF</code> \u2014 d\u00e9finitions. Recherche par CUI\u00a0; sources pr\u00e9f\u00e9r\u00e9es par ordre\u00a0: '
      + '<code>MSH</code> (MeSH), <code>NCI</code> (NCI Thesaurus), <code>CSP</code> (CRISP), '
      + '<code>ICF</code>, <code>HPO</code>, <code>MEDLINEPLUS</code>.</li>'
      + '<li><code>MRSTY.RRF</code> \u2014 type s\u00e9mantique (par ex. <em>T201 \u2014 Clinical Attribute</em>).</li>'
      + '<li><code>MRREL.RRF</code> \u2014 relations (parent/enfant, concepts li\u00e9s).</li>'
      + '</ul></li>'
      + '</ul>'

      + '<h3>4. Sources web</h3>'
      + '<p>Sources de dernier recours, citées dans la section <em>Références</em>.</p>'
      + '<p>Pour les concepts de niche o\u00f9 LOINC, SNOMED et UMLS sont insuffisants, des recommandations cliniques '
      + 'r\u00e9vis\u00e9es par les pairs, des prises de position de soci\u00e9t\u00e9s savantes ou des r\u00e9f\u00e9rences m\u00e9dicales '
      + '\u00e9tablies (StatPearls, UpToDate, sites de soci\u00e9t\u00e9s savantes) peuvent \u00eatre cit\u00e9es. Toute source web est consign\u00e9e '
      + 'dans la section <em>R\u00e9f\u00e9rences</em> de la description (num\u00e9rot\u00e9e, format Vancouver, avec URL cliquable).</p>'

      // ===== RECOMMENDED UNITS =====
      + '<h2>Unit\u00e9s recommand\u00e9es</h2>'
      + '<p>Stock\u00e9es dans <code>units/recommended_units.json</code>.</p>'
      + '<p>L\u2019unit\u00e9 recommand\u00e9e pour chaque concept de mesure provient de deux sources, par ordre de priorit\u00e9. '
      + 'Pour les mesures de laboratoire, <strong>NPU</strong> est la source primaire \u2014 il s\u2019agit de la r\u00e9f\u00e9rence '
      + 'IFCC/IUPAC qui publie explicitement l\u2019unit\u00e9 SI / IFCC recommand\u00e9e pour chaque mesurande. Quand NPU ne '
      + 'couvre pas la mesure, <strong>LOINC <code>EXAMPLE_UCUM_UNITS</code></strong> est utilis\u00e9 en repli '
      + '(l\u2019unit\u00e9 la plus fr\u00e9quemment observ\u00e9e en pratique pour ce code LOINC). Pour les mesures non biologiques '
      + '(signes vitaux, anthropom\u00e9trie, scores, doses m\u00e9dicamenteuses), aucune source formelle n\u2019est encore retenue.</p>'

      + '<h3>1. NPU</h3>'
      + '<p>Source primaire pour les mesures de laboratoire. <em>Nomenclature for Properties and Units</em> '
      + '(IFCC / IUPAC). NPU est plus large que JCTLM (il couvre les concentrations, activit\u00e9s, ratios, panels '
      + 'qualitatifs) et publie explicitement \u00e0 la fois la variante SI et la variante conventionnelle quand les '
      + 'deux sont en usage (ex. <code>\u00b5kat/L</code> et <code>U/L</code> pour les activit\u00e9s enzymatiques).</p>'
      + '<ul>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: <a href="https://npu-terminology.org/npu-database/" target="_blank">'
      + 'https://npu-terminology.org/npu-database/</a> (gratuit).</li>'
      + '<li><strong>Fichier utilis\u00e9</strong>\u00a0: la derni\u00e8re version <code>npu-codes-latest.csv</code>.</li>'
      + '<li><strong>Colonnes cl\u00e9s</strong>\u00a0:'
      + '<ul>'
      + '<li><code>npu_code</code> \u2014 le code NPU.</li>'
      + '<li><code>system</code> \u2014 \u00e9chantillon (ex. <code>Plasma</code>, <code>Serum</code>, <code>Capillary blood</code>, <code>Blood</code>, <code>Patient(blood)</code>).</li>'
      + '<li><code>component</code> \u2014 la grandeur mesur\u00e9e (ex. <em>Bilirubins</em>, <em>Glucose</em>).</li>'
      + '<li><code>kind_of_property</code> \u2014 type de propri\u00e9t\u00e9 (ex. <em>substance concentration</em>, <em>catalytic activity concentration</em>).</li>'
      + '<li><code>unit</code> \u2014 nom complet de l\u2019unit\u00e9 (ex. <em>micromole per litre</em>).</li>'
      + '<li><code>unit_short</code> \u2014 forme courte type UCUM (ex. <code>\u00b5mol/L</code>, <code>\u00b5kat/L</code>, <code>U/L</code>).</li>'
      + '<li><code>active</code> \u2014 <code>1</code> pour les lignes actives.</li>'
      + '</ul></li>'
      + '<li><strong>Filtre</strong>\u00a0: <code>active = 1</code> et <code>component</code> correspondant \u00e0 la grandeur mesur\u00e9e. '
      + 'Pour les enzymes, deux lignes existent g\u00e9n\u00e9ralement (variante SI <code>\u00b5kat/L</code> et variante conventionnelle '
      + '<code>U/L</code>) \u2014 les deux sont accept\u00e9es\u00a0; choisir la variante r\u00e9ellement rapport\u00e9e par les laboratoires.</li>'
      + '</ul>'

      + '<h3>2. LOINC (repli)</h3>'
      + '<p>Utilis\u00e9 quand la mesure n\u2019est pas couverte par NPU. L\u2019unit\u00e9 recommand\u00e9e est lue dans la colonne '
      + '<code>EXAMPLE_UCUM_UNITS</code> de <code>LoincTable/Loinc.csv</code>. Une unit\u00e9 choisie \u00e0 partir de LOINC '
      + 'seul ne doit pas \u00eatre pr\u00e9sent\u00e9e comme l\u2019\u00ab\u00a0unit\u00e9 SI\u00a0\u00bb ou \u00ab\u00a0recommand\u00e9e par l\u2019IFCC\u00a0\u00bb \u2014 ces affirmations '
      + 'requi\u00e8rent NPU comme source citable.</p>'
      + '<ul>'
      + '<li><strong>Fichier</strong>\u00a0: <code>LoincTable/Loinc.csv</code> (distribution LOINC \u2014 voir section pr\u00e9c\u00e9dente pour le t\u00e9l\u00e9chargement).</li>'
      + '<li><strong>Colonne</strong>\u00a0: <code>EXAMPLE_UCUM_UNITS</code> \u2014 l\u2019unit\u00e9 UCUM la plus fr\u00e9quemment observ\u00e9e '
      + 'en pratique pour ce code LOINC, telle que publi\u00e9e par Regenstrief.</li>'
      + '<li><strong>Valeurs multiples</strong>\u00a0: la colonne peut lister plusieurs unit\u00e9s s\u00e9par\u00e9es par <code>;</code> '
      + '(ex. <code>mg/dL;mg/L</code> pour certains dosages d\u2019albumine). Choisir celle qui correspond au '
      + '<code>PROPERTY</code> LOINC (<code>\u00b5mol/L</code> pour <em>SCnc</em> / <em>Moles/volume</em>, '
      + '<code>mg/dL</code> pour <em>MCnc</em> / <em>Mass/volume</em>)\u00a0; quand le <em>property</em> ne d\u00e9sambigu\u00efse '
      + 'pas, choisir celle la plus utilis\u00e9e en pratique et documenter le choix.</li>'
      + '</ul>'

      + '<h3>3. Mesures non biologiques</h3>'
      + '<p>Pour les signes vitaux, l\u2019anthropom\u00e9trie, les scores cliniques, les doses m\u00e9dicamenteuses et autres '
      + 'mesures non biologiques, la m\u00e9thodologie pour choisir une unit\u00e9 recommand\u00e9e n\u2019est <strong>pas encore '
      + 'd\u00e9finie</strong>\u00a0: la colonne LOINC <code>EXAMPLE_UCUM_UNITS</code> est peu renseign\u00e9e dans ces domaines, '
      + 'NPU ne les couvre pas, et aucune r\u00e9f\u00e9rence transversale n\u2019a \u00e9t\u00e9 retenue \u00e0 ce jour. Pour l\u2019instant, les '
      + 'unit\u00e9s recommand\u00e9es dans ces domaines sont renseign\u00e9es au cas par cas (recommandations cliniques, usage '
      + 'courant).</p>'

      // ===== UNIT CONVERSIONS =====
      + '<h2>Facteurs de conversion</h2>'
      + '<p>Stock\u00e9s dans <code>units/unit_conversions.json</code>.</p>'
      + '<p>Les facteurs de conversion proviennent de la r\u00e9f\u00e9rence nationale fran\u00e7aise pour les \u00e9changes de r\u00e9sultats de biologie\u00a0:</p>'
      + '<ul>'
      + '<li><strong>Source</strong>\u00a0: <em>Jeu de valeurs Circuit de la biologie</em>, publi\u00e9 par l\u2019<strong>Agence du Num\u00e9rique en Sant\u00e9 (ANS)</strong> '
      + 'dans le cadre du Cadre d\u2019Interop\u00e9rabilit\u00e9 des Syst\u00e8mes d\u2019Information de Sant\u00e9 (CI-SIS).</li>'
      + '<li><strong>Page de pr\u00e9sentation</strong>\u00a0: <a href="https://smt.esante.gouv.fr/terminologie-jeu-de-valeurs-circuit-de-la-biologie/" target="_blank">'
      + 'https://smt.esante.gouv.fr/terminologie-jeu-de-valeurs-circuit-de-la-biologie/</a></li>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: l\u2019archive ZIP li\u00e9e depuis la page ci-dessus '
      + '(par ex. <code>terminologie-jeu-de-valeurs-circuit-de-la-biologie-1.1.23.zip</code>). Le fichier exploit\u00e9 est '
      + '<code>dat/ANS_JDV_CircuitBio.xlsx</code>.</li>'
      + '<li><strong>Feuille</strong>\u00a0: <code>1.JDV_CircuitBio</code> \u2014 une ligne par code LOINC pr\u00e9sent dans le jeu de valeurs national '
      + '(~7\u00a0100 lignes en v1.1.23).</li>'
      + '<li><strong>Mise en page de l\u2019en-t\u00eate</strong>\u00a0: la ligne 1 est un bandeau th\u00e9matique (ex. <em>Renseignements pr\u00e9l\u00e8vements</em>, '
      + '<em>ANALYSES PORTEUSES DE RESULTAT</em>), la ligne 2 contient les en-t\u00eates de colonnes, les donn\u00e9es commencent ligne 3.</li>'
      + '<li><strong>Colonnes cl\u00e9s</strong>\u00a0:'
      + '<ul>'
      + '<li>Colonne 19 \u2014 <code>LOINC</code> \u2014 le code LOINC de la mesure (ex. <code>14749-6</code>).</li>'
      + '<li>Colonne 20 \u2014 <em>Libell\u00e9s fran\u00e7ais de r\u00e9f\u00e9rence</em>.</li>'
      + '<li>Colonne 24 \u2014 <em>Unit\u00e9 recommand\u00e9e</em> \u2014 l\u2019unit\u00e9 recommand\u00e9e (ex. <code>mmol/L</code>).</li>'
      + '<li>Colonne 25 \u2014 <em>Unit\u00e9 UCUM</em> \u2014 l\u2019unit\u00e9 au format UCUM.</li>'
      + '<li>Colonne 27 \u2014 <em>Correspondance</em> \u2014 le code LOINC du test partenaire '
      + '(m\u00eame mesure, unit\u00e9 alternative\u00a0; ex. <code>14749-6</code> Glucose <em>mmol/L</em> \u2194 <code>2345-7</code> Glucose <em>g/L</em>).</li>'
      + '<li>Colonne 28 \u2014 <em>Facteur de conversion des unit\u00e9s</em> \u2014 le facteur multiplicatif pour convertir l\u2019unit\u00e9 '
      + 'de la ligne courante vers l\u2019unit\u00e9 de la ligne partenaire (ex. <code>0,18</code> de <code>mmol/L</code> Glucose vers '
      + '<code>g/L</code>, <code>5,551</code> dans le sens inverse).</li>'
      + '</ul></li>'
      + '<li><strong>Mapping vers INDICATE</strong>\u00a0: chaque ligne ANS produit (au plus) une entr\u00e9e dans '
      + '<code>units/unit_conversions.json</code> avec <code>conceptId</code> = ID OMOP du code LOINC en colonne 19, '
      + '<code>sourceUnitCode</code> = colonne 24, <code>targetUnitCode</code> = colonne 24 de la ligne partenaire, '
      + '<code>conversionFactor</code> = colonne 28. Les deux directions sont stock\u00e9es comme deux lignes distinctes '
      + '(une ligne par direction, conform\u00e9ment au sch\u00e9ma document\u00e9).</li>'
      + '<li><strong>Documentation associ\u00e9e</strong>\u00a0: <code>doc/Guide_Implementation_JDV_Circuit_de_biologie.pdf</code> et '
      ...
      + '<p>Chaque concept du dictionnaire est associ\u00e9 \u00e0 un <code>concept_id</code> OMOP. Les m\u00e9tadonn\u00e9es des concepts '
      + '(<code>concept_name</code>, <code>concept_code</code>, <code>vocabulary_id</code>, <code>domain_id</code>, '
      + '<code>concept_class_id</code>, <code>standard_concept</code>, <code>valid_start_date</code>, <code>valid_end_date</code>) '
      + 'sont charg\u00e9es \u00e0 partir des tables vocabulaire OHDSI Athena.</p>'
      + '<ul>'
      + '<li><strong>T\u00e9l\u00e9chargement</strong>\u00a0: <a href="https://athena.ohdsi.org/" target="_blank">https://athena.ohdsi.org/</a> '
      + '(gratuit, compte OHDSI requis). S\u00e9lectionnez les vocabulaires n\u00e9cessaires (LOINC, SNOMED, RxNorm, ATC, UCUM, etc.) '
      + 'et t\u00e9l\u00e9chargez-les au format CSV.</li>'
      + '<li><strong>Tables utilis\u00e9es</strong>\u00a0: <code>CONCEPT</code>, <code>CONCEPT_ANCESTOR</code>, <code>CONCEPT_RELATIONSHIP</code>, '
      + '<code>CONCEPT_SYNONYM</code>, <code>RELATIONSHIP</code>, <code>VOCABULARY</code>, <code>DOMAIN</code>, '
      + '<code>CONCEPT_CLASS</code>, optionnellement <code>DRUG_STRENGTH</code>.</li>'
      + '<li><strong>Recherche par concept</strong>\u00a0: <code>https://athena.ohdsi.org/search-terms/terms/{conceptId}</code> '
      + '(li\u00e9 depuis chaque concept dans l\u2019application).</li>'
      + '<li><strong>Requ\u00eate locale</strong>\u00a0: les m\u00eames CSV peuvent \u00eatre charg\u00e9s dans la base DuckDB-WASM int\u00e9gr\u00e9e au navigateur '
      + '(voir ' + docLink('dictionary-settings', 'Param\u00e8tres du dictionnaire') + ' \u2192 Param\u00e8tres g\u00e9n\u00e9raux \u2192 Import du vocabulaire) '
      + 'puis interrog\u00e9s depuis ' + docLink('dev-tools', 'Outils de d\u00e9veloppement') + '.</li>'
      + '</ul>'

      // ===== UCUM =====
      + '<h2>UCUM</h2>'
      + '<p>Tous les codes d\u2019unit\u00e9s du dictionnaire suivent la syntaxe UCUM (<em>Unified Code for Units of Measure</em>). '
      + 'UCUM est \u00e9galement distribu\u00e9 comme un vocabulaire OMOP '
      + '(chaque unit\u00e9 a un <code>concept_id</code> OMOP, par ex. <code>8753 \u2014 mmol/L</code>, <code>8636 \u2014 g/L</code>, '
      + '<code>8554 \u2014 %</code>).</p>'
      + '<ul>'
      + '<li><strong>Sp\u00e9cification</strong>\u00a0: <a href="https://ucum.org/ucum" target="_blank">https://ucum.org/ucum</a></li>'
      + '<li><strong>Distribution comme vocabulaire OMOP</strong>\u00a0: t\u00e9l\u00e9chargement via Athena (voir ci-dessus) puis recherche des codes '
      + 'avec <code>SELECT * FROM concept WHERE vocabulary_id = \'UCUM\';</code></li>'
      + '</ul>';
  }
